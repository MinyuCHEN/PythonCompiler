...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon May 30 19:43:13 CST 2016
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\006\006\006\010\005\001\002\000\010\002" +
    "\uffff\006\uffff\010\uffff\001\002\000\010\004\ufffa\005\ufffa" +
    "\007\ufffa\001\002\000\006\006\006\010\005\001\002\000" +
    "\010\002\016\006\006\010\005\001\002\000\006\004\ufffe" +
    "\005\012\001\002\000\004\004\014\001\002\000\004\010" +
    "\013\001\002\000\010\004\ufffc\005\ufffc\007\ufffc\001\002" +
    "\000\010\002\ufffd\006\ufffd\010\ufffd\001\002\000\010\002" +
    "\001\006\001\010\001\001\002\000\004\002\000\001\002" +
    "\000\006\005\012\007\020\001\002\000\010\004\ufffb\005" +
    "\ufffb\007\ufffb\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\010\002\006\003\003\004\007\001\001\000" +
    "\002\001\001\000\002\001\001\000\004\004\016\001\001" +
    "\000\006\003\014\004\007\001\001\000\004\007\010\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Object n = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 System.out.print("ACEPT"); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr",2, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // expr ::= L_PARENTHESIS_OP expr R_PARENTHESIS_OP 
            {
              Integer RESULT =null;
		...
		Integer e = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 System.out.print("ACEPT"); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // expr ::= expr ARITH_OP NUM_LIT 
            {
              Integer RESULT =null;
		...
		Object f = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 System.out.print("ACEPT"); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // expr_part ::= expr NT$0 SEMICOLON_OP 
            {
              Object RESULT =null;
